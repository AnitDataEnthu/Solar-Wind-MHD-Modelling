...
class Model(object):
  ...
  def __init__(self, configs):
    ...
    if self.configs.pretrained_model:
      self.saver.restore(self.sess, self.configs.save_dir+self.configs.pretrained_model)
  ...
  def save(self, itr):
    checkpoint_path = os.path.join(self.configs.save_dir, 'model.ckpt-15000.data-00000-of-00001')
